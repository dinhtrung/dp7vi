...
/**
 * @file
 * Contains functions to alter Drupal's markup for the dp7admin theme.
 *
 * IMPORTANT WARNING: DO NOT MODIFY THIS FILE.
 *
 * The base dp7admin theme is designed to be easily extended by its sub-themes. You
 * shouldn't modify this or any of the CSS or PHP files in the root dp7admin/ folder.
 * See the online documentation for more information:
 *   https://drupal.org/documentation/theme/dp7admin
 */
...
drupal_set_message ( t ( 'For easier theme development, the theme registry is being rebuilt on every page request. It is <em>extremely</em> important to <a href="!link">turn off this feature</a> on production websites.', array (
 ...
 */
function dp7admin_breadcrumb($variables) {
	...
	$show_breadcrumb_home = theme_get_setting ( 'dp7admin_breadcrumb_home' );
 ...
 *
 * @param $variables An
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered. This is usually "html", but can
 *        	also be "maintenance_page" since dp7admin_preprocess_maintenance_page() calls
 *        	this function to have consistent variables.
 */
function dp7admin_preprocess_html(&$variables, $hook) {
	// Add variables and paths needed for HTML5 and responsive support.
	$variables ['base_path'] = base_path ();
	$variables ['directory'] = base_path () . drupal_get_path ( 'theme', 'dp7admin' );
 ...
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered ("html" in this case.)
 */
function dp7admin_process_html(&$variables, $hook) {
 ...
 */
function dp7admin_process_html_tag(&$variables) {
 ...
 */
function dp7admin_html_head_alter(&$head) {
 ...
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered ("page" in this case.)
 */
function dp7admin_preprocess_page(&$variables, $hook) {
 ...
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered ("maintenance_page" in this case.)
 */
function dp7admin_preprocess_maintenance_page(&$variables, $hook) {
	dp7admin_preprocess_html ( $variables, $hook );
	// There's nothing maintenance-related in dp7admin_preprocess_page(). Yet.
	// dp7admin_preprocess_page($variables, $hook);
}
 ...
 *        	name of the template being rendered ("maintenance_page" in this case.)
 */
function dp7admin_process_maintenance_page(&$variables, $hook) {
	dp7admin_process_html ( $variables, $hook );
 ...
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered ("node" in this case.)
 */
function dp7admin_preprocess_node(&$variables, $hook) {
 ...
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered ("comment" in this case.)
 */
function dp7admin_preprocess_comment(&$variables, $hook) {
 ...
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered ("region" in this case.)
 */
function dp7admin_preprocess_region(&$variables, $hook) {
	// Sidebar regions get some extra classes and a common template suggestion.
	if (strpos ( $variables ['region'], 'sidebar_' ) === 0) {
		$variables ['classes_array'] [] = 'column';
		$variables ['classes_array'] [] = 'sidebar';
		// Allow a region-specific template to override dp7admin's region--sidebar.
	...
	elseif ($variables ['region'] == 'content') {
		// Allow a region-specific template to override dp7admin's region--no-wrapper.
 ...
 *        	array of variables to pass to the theme template.
 * @param $hook The
 *        	name of the template being rendered ("block" in this case.)
 */
function dp7admin_preprocess_block(&$variables, $hook) {
	...
	// The last_in_region property is set in dp7admin_page_alter().
 ...
 *        	name of the template being rendered ("block" in this case.)
 */
function dp7admin_process_block(&$variables, $hook) {
 ...
 */
function dp7admin_page_alter(&$page) {
 ...
 */
function dp7admin_form_node_form_alter(&$form, &$form_state, $form_id) {
 ...
 * @ingroup themeable
 */
function dp7admin_menu_local_tasks(&$variables) {
	$output = '';
 ...
 * @ingroup themeable
 */
function dp7admin_menu_local_task($variables) {
	$type = $class = FALSE;

	$link = $variables ['element'] ['#link'];
	$link_text = $link ['title'];

	// Check for tab type set in dp7admin_menu_local_tasks().
 ...
 */
function dp7admin_preprocess_menu_link(&$variables, $hook) {
 ...
 */
function dp7admin_status_messages($variables) {
 ...
 */
function dp7admin_mark($variables) {
	$type = $variables ['type'];
 ...
 */
function dp7admin_panels_default_style_render_region($variables) {
